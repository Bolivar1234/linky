...
export default async function BlogPostPage({
  ...
  const articleJsonLd = {
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://giv.e/assets/logo.png',
      },
    },
  ...
  const shareIcons = [
    {
      name: 'X / Twitter',
      href: `https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://giv.e/i/blog/${blogPost.slug}`)}&text=${encodeURIComponent(blogPost.title)}`,
      icon: 'https://cdn.giv.e/default-data/icons/twitter-x.svg',
    },
    {
      name: 'Facebook',
      href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://giv.e/i/blog/${blogPost.slug}`)}`,
      icon: 'https://cdn.giv.e/default-data/icons/facebook.svg',
    },
    {
      name: 'LinkedIn',
      href: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://giv.e/i/blog/${blogPost.slug}`)}`,
      icon: 'https://cdn.giv.e/default-data/icons/linkedin.svg',
    },
    {
      name: 'Reddit',
      href: `https://www.reddit.com/submit?url=${encodeURIComponent(`https://giv.e/i/blog/${blogPost.slug}`)}&title=${encodeURIComponent(blogPost.title)}`,
      icon: 'https://cdn.giv.e/default-data/icons/reddit.svg',
    },
    {
      name: 'WhatsApp',
      href: `https://api.whatsapp.com/send?text=${encodeURIComponent(blogPost.title + ' https://giv.e/i/blog/' + blogPost.slug)}`,
      icon: 'https://cdn.giv.e/default-data/icons/whatsapp.svg',
    },
  ];
